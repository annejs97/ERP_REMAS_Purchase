...
{
    /// <summary>
    /// Navigation control 'Transparency' theme
    /// </summary>
    public class TransparencyTheme : ITheme
    {
        ...
        private Color DEFAULT_BACKGROUND_COLOR_NO_DEPHT = Color.FromArgb(100,0,0,0);
        private Color DEFAULT_SELECTED_BACKGROUND_COLOR_NO_DEPTH = Color.FromArgb(50, 0, 68, 124);
        private Color DEFAULT_HOVER_BACKGROUND_COLOR_NO_DEPTH = Color.FromArgb(100, 15, 45, 60);
        ...
        private SolidBrush DEFAULT_BRUSH_FONT_HOVER_NO_DEPTH = new SolidBrush(Color.FromArgb(127, 54, 239, 124));
        ...
        private List<Color> GetBackgroundColor
        {
            get
            {
                ...
                l.Add(Color.FromArgb(250));
                //l.Add(Color.FromArgb(250, 50, 105, 190));
                //l.Add(Color.FromArgb(250, 60, 115, 200));
                //l.Add(Color.FromArgb(250, 70, 125, 210));
        ...
        private List<SolidBrush> GetBrushFontHover
        {
            ...
            {
                List<SolidBrush> l = new List<SolidBrush>();
                l.Add(new SolidBrush(Color.Gray));
